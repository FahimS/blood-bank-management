...
if(isset($_POST['btn-update'])){
  ...
  $update = "UPDATE user SET name='$name', username='$username' , gender='$gender' , bgroup='$bgroup' , ddate='$ddate' , mobile='$mobile' , address='$address' , email='$email' WHERE id=". $_GET['edit_id'];
...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:20%;top: 0;background-color: #989898 !important;color: #fff !important;font-size: 18px;">
  ...
  <a id="active" href="view_donor.php" class="w3-bar-item w3-button">View Donor</a><br>
...
<option>O-</option>
 ...
 <label for="ddate" class="control-label col-sm-3">Last Date of Donate:</label>
 <div class="col-sm-8">
 
<input id="num" type="date" class="form-control" name="ddate" placeholder="Last Date of Donate" value="<?php echo $row['ddate']; ?>">
...
<div class="col-sm-8">
<input id="num" type="email" class="form-control"  name="email" placeholder="Email" value="<?php echo $row['email']; ?>">
     </div>
    </div>
