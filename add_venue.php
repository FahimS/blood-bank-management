...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:20%;top: 0;background-color: #989898 !important;color: #fff !important;font-size: 18px;">
  ...
  <a id="active" href="add_venue.php" class="w3-bar-item w3-button">Add Venue</a>
...
<!-- .............content here.............. -->
<div class="add_venue_form templete clear">
		<h1>Venue Registretion Form</h1>
		...
		<?php 
			if (isset($_POST['register'])) {
				...
				$sql = "INSERT into blood_camp(date,time,venue,mobile,email) values('$date','$time','$venue','$mobile','$email')";
				$res = mysqli_query($conn, $sql);
				if ($res) {
					echo "<script>alert('Registration Successful')</script>";
        echo"<script>window.open('view_venue.php','_self')</script>";
				}else{
		...
		<form method="post" action="">
			<label>Date:</label><br>
			<input type="date" name="date" id="num"><br><br>

			<label>Time:</label><br>
			<input type="text" name="time" id="num"><br><br>
			...
			<textarea id="text" name="venue"  placeholder="Enter Address Here"></textarea><br><br>
