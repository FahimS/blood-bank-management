...
<div class="view_admin_bloodbank">
    ...
    if($key !="")
    {
        $query="SElECT * FROM blood_bank WHERE name  like '%$key%' ";
    ...
    ?>
      <tr bgcolor="<?php echo $color?>">
          ...
          <td><?php echo $row['institution'];?></td>
           ...
           <td><a href="update_bank.php?edit_id=<?php echo $row['id'];?>" title="Update"><img style="width: 30px;" src="image/updatesicon.png" /></a></td>
