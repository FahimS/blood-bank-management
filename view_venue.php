...
<?php
$con =mysqli_connect("localhost","root","","blood") or die (mysql_error());
...
<div class="view_admin_bloodbank">
    ...
    if($key !="")
    {
        $query="SElECT * FROM blood_camp WHERE name  like '%$key%' ";
    ...
    ?>
      <tr bgcolor="<?php echo $color?>">
          ...
          <td><?php echo $row['time'];?></td>
           ...
           <td><a href="update_venue.php?edit_id=<?php echo $row['id'];?>" title="Update"><img style="width: 30px;" src="image/updatesicon.png" /></a></td>
