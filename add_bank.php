...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:20%;top: 0;background-color: #989898 !important;color: #fff !important;font-size: 18px;">
  ...
  <a href="view_venue.php" class="w3-bar-item w3-button">View Venue</a><br>
    ...
    <a id="active" href="add_bank.php" class="w3-bar-item w3-button">Add Blood Bank</a>
...
<!-- .............content here.............. -->
	...
	<div class="add_bloobank_form templete clear">
		<h1>Blood Bank Registretion Form</h1>
		...
		<?php 
			if (isset($_POST['register'])) {
				...
				$sql = "INSERT into blood_bank(address,blood_bank,institution,mobile,email) values('$address','$blood_bank','$institution','$mobile','$email')";
				$res = mysqli_query($conn, $sql);
				if ($res) {
					echo "<script>alert('Registration Successful')</script>";
        echo"<script>window.open('view_bank.php','_self')</script>";
				}else{
		...
		<form method="post" action="">
			...
			<input type="text" name="blood_bank" id="num" placeholder="Enter Blood Bank" required><br><br>

			<label>Institution Name:</label><br>
			<input type="text" name="institution" id="num" placeholder="Enter Institution Name" required><br><br>

			<label>Mobile Nub:</label><br>
			<input type="tel" name="mobile" placeholder="Enter Mobile Number" id="num"><br><br>
			
			<label>Email:</label><br>
			<input type="email" name="email" id="num" placeholder="Enter Email" required><br><br>

			<label>Address:</label><br>
			<textarea id="text" name="address" rows="5" cols="50" placeholder="Enter Address Here"></textarea><br><br>
